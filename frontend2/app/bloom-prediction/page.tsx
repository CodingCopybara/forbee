...
const locations: Location[] = [
  ...
  { id: "6", name: "고산", coordinates: [33.2938, 126.1628], station: "고산지구대기감시소, 제주특별자치도 제주시 한경면 노을해안로 1013-70" },
  ...
  { id: "31", name: "부여", coordinates: [36.2724, 126.9208], station: "부여기상관측소, 충청남도 부여군 부여읍 금성로 63" },
  { id: "32", name: "부안", coordinates: [35.7296, 126.7166], station: "부안기상관측소, 전북특별자치도 부안군 행안면 변산로 42" },
  ...
  { id: "36", name: "보은", coordinates: [36.4876, 127.7342], station: "보은기상관측소, 충청북도 보은군 보은읍 성주길 57" },
  ...
  { id: "41", name: "성산", coordinates: [33.3868, 126.8802], station: "성산포, 제주특별자치도 서귀포시 성산읍 신난로" },
  ...
  { id: "50", name: "영주", coordinates: [36.8718, 128.5169], station: "영주기상관측소, 경상북도 영주시 풍기읍 남원로 178" },
  { id: "51", name: "영천", coordinates: [35.9774, 128.9514], station: "영천기상관측소, 경상북도 영천시 망정3길 35" },
  { id: "52", name: "완도", coordinates: [34.3959, 126.7018], station: "완도기상대, 전라남도 완도군 군외면 청해진로 795-3" },
  ...
  { id: "60", name: "인제", coordinates: [38.0599, 128.1681], station: "인제기상관측소, 강원특별자치도 인제군 인제읍 남북리 815-1" },
  ...
  { id: "64", name: "장흥", coordinates: [34.6889, 126.9195], station: "장흥기상관측소, 전라남도 장흥군 장흥읍 흥성로 226" },
  ...
  { id: "85", name: "홍성", coordinates: [36.6576, 126.6877], station: "홍성기상대, 충청남도 홍성군 홍북읍 홍예로 350" },
  { id: "86", name: "홍천", coordinates: [37.6836, 127.8804], station: "홍천기상관측소, 강원특별자치도 홍천군 홍천읍 연봉동로 27" },
  { id: "87", name: "흑산도", coordinates: [34.6872, 125.4511], station: "흑산도기상대, 전라남도 신안군 흑산면 예리3길 21-90" },
];
