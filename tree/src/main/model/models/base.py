...
class BaseModel:
    ...
    NO_FIT = config.SEASON_LENGTH - config.DOY_SHIFT  # DOY at end of season
    NO_FIT_IX = config.SEASON_LENGTH
    ...
    def predict(self, x: dict) -> tuple:
        ...
        doy = config.index_to_doy(ix) if bloom else BaseModel.NO_FIT
